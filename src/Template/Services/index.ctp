    ...
    <div class="container text-center mb-xl">
        <div class="row">
            <div class="col-md-4 mb-sm">
                ...
                <h5>Support</h5>
                <p class="text-grey">
                    You will get assistance from the core team by email or Zoom. Install troubles? Understanding how eramba works? Implementation advice? We got it covered.
                </p>
            </div>
            <div class="col-md-4 mb-sm">
            ...
            <div class="col-md-4 mb-sm">
                ...
                <p class="text-grey">
                    Email Notifications, Custom Fields, Online Assessments, Awareness Programs, Etc. See the full list in our <a href="https://www.eramba.org/documentation">documentation</a>.
                </p>
            </div>
        </div>
    </div>
