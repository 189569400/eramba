    ...
    <div class="container text-center mb-xl">
		...
		We have prepared a Vmware image with eramba pre-installed
            ...
            <div class="col-md-3 mb-sm">
                ...
                <h5>Amazon AMI</h5>
                <p class="text-grey">
		 Use our AMIs from Amazon Marketplace to quickly deploy eramba 
                </p>
            </div>
            <div class="col-md-3 mb-sm">
                ...
                <h5>Hosted SaaS</h5>
                <p class="text-grey">
		We can host eramba for you on our <a href="http://www2.eramba.org/services">SaaS environment</a>
                </p>
            </div>
        </div>
    </div>
