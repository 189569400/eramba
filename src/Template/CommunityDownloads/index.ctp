        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <?= $this->Form->create(isset($communityDownload) ? $communityDownload : null, ['url' => ['controller' => 'CommunityDownloads', 'action' => 'add']]) ?>
                    ...
                    <div class="form-group">
                        <label>Email where we'll send the download link?</label>
                    ...
                    <div class="form-check text-left mb-md">
                        ...
                        <label class="form-check-label form-check-label-small" for="form-check-policy-consent">Review and only submit if you agree to our <a href="#">privacy policy</a></label>
