    ...
    <div class="container text-center mb-xl">
        <div class="row">
            <div class="col-md-3 mb-sm">
                ...
                <h5>Source Code</h5>
                <p class="text-grey">
                    Install eramba using our source code, you will Linux skills and our install guides.
                </p>
            </div>
            <div class="col-md-3 mb-sm">
                ...
                <h5>VM</h5>
                <p class="text-grey">
                    a Vmware image makes the install process a lot easier for those not interested in Linux.
                </p>
            </div>
            <div class="col-md-3 mb-sm">
                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" viewBox="0 0 24 24" height="100" width="100" class="mb-xs icon-md"><title></title><g transform="matrix(1,0,0,1,0,0)"><path d="M 22.95,19.533c-12.3,6.719-21.594-0.082-21.594-0.082 " stroke="#000000" fill="none" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"></path><path d="M 20.593,23.337c1.432-0.755,2.658-2.937,2.363-3.787 l-0.006-0.017c-0.26-0.559-2.586-1.414-4.39-0.7 " stroke="#000000" fill="none" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"></path><path d="M 12.928,7.9C8.383,8.24,4.3,8.995,4.3,13.686c-0.21,2.28,1.467,4.299,3.747,4.509 c0.207,0.019,0.414,0.023,0.622,0.011c1.858,0.111,3.655-0.683,4.823-2.133c0.45,0.728,1.014,1.379,1.671,1.927 c0.229,0.111,0.499,0.092,0.71-0.051c0.61-0.508,1.677-1.423,2.235-1.929c0.218-0.199,0.241-0.535,0.051-0.761 c-0.716-0.713-1.118-1.682-1.118-2.692V8c0-1.929,0.153-3.708-1.269-5.025C14.518,1.98,12.954,1.458,11.354,1.5 C8.1,1.5,5.4,2.829,4.8,5.969C4.726,6.222,4.87,6.487,5.123,6.561C5.15,6.569,5.179,6.575,5.207,6.578L8.05,6.932 c0.272-0.057,0.477-0.281,0.508-0.557c0.267-1.089,1.27-1.835,2.39-1.775c0.632-0.017,1.234,0.266,1.625,0.762 C12.93,6.157,13.053,7.037,12.928,7.9z " stroke="#000000" fill="none" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"></path><path d="M 12.37,13.942c-0.97,1.935-3.809,1.941-3.809-0.762c-0.058-1.331,0.874-2.501,2.184-2.742 c0.718-0.147,1.45-0.214,2.183-0.2v0.61C13.053,11.912,12.859,12.988,12.37,13.942L12.37,13.942z" stroke="#000000" fill="none" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"></path></g></svg>
                <h5>Amazon AMI</h5>
                <p class="text-grey">
                    Use our AMIs to deploy eramba at Amazon in no time!
                </p>
            </div>
            <div class="col-md-3 mb-sm">
                ...
                <h5>Hosted SaaS</h5>
                <p class="text-grey">
                    We can host eramba for you on our SaaS infrastructure. <a href="/services">Learn more</a> about this paid service.
                </p>
            </div>
        </div>
    </div>
