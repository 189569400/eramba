...
class DocumentationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'link' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => '', 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'video' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => '', 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'category' => 1,
                'created' => '2019-06-13 14:00:16',
                'modified' => '2019-06-13 14:00:16'
            ],
        ];
        parent::init();
    }
